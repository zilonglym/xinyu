...
<body>
	...
	<ul class="nav nav-tabs">
	  <li class="active"><a href="#upload" data-toggle="tab">批量订单导入</a></li>
	</ul>
    <div class="tab-content">
    	<!--ERP订单导入 -->
    	<div class="tab-pane active" id="upload">
		<form id="uploadForm" action="${ctx}/import/order/uploadOrder" method="post" enctype="multipart/form-data" class="form-horizontal">
