...
public class Trade  implements Serializable{
	...
	public static String titleAndCodeSplit="Z@C";
	/**
	 * 面单上面打印商品的CODE需不是标题的商家编号
	 */
	public static String splitByTB="51,52,53,55";
	/**
	 * 来源标记
	 * @author shark_cj
	 *
	...
	public interface SourceFlag{
		 ...
		 * 来自奇门同步单据
		 */
		String  SourceFlag_QM = "QM";
		
		/**
		 * 来excl导入
		 */
		String  SourceFlag_IMPORT = "IMPORT";
		
		
		/**
		 * 来ERP导入
		 */
		String  SourceFlag_ERP = "ERP";
		/**
		 * 来自系统本身
		 */
		String SourceFlag_STORE="STORE";
	}
	...
	public interface Status {
	     ...
	     * 删除的订单
	     */
	    String TRADE_WMS_DELETED="TRADE_WMS_DELETED";
	...
	/**
	 * 支付时间 也就是订单创建时间,奇门的单据这个时间改为推单过来的时间，也就是我们系统的创建时间6
	 */
	 ...
	 * 次日达订单送达时间
	 */
	private String lgAging;//奇门发货单 存放shipOrder 的ID

	/**
	 * 次日达，三日达等送达类型   、奇门发货单编码  deliveryOrderCode 
	 */
