package com.xinyu.service.express.yunda;
...
import com.xinyu.service.express.yunda.api.DataSecurity;
import com.xinyu.service.express.yunda.api.HttpClient;
...
// 		
// 		private static String  checkAddressUrl=  "http://orderdev.yundasys.com:10110/cus_order/order_interface/interface_new_package.php";
//		
		...
		public Map<String, Object> checkYunDaAddressByList(Map<String,Map<String,Object>>  maps) {
			...
			try {
				...
				while (iter.hasNext()) {
					...
					System.err.println("id:"+value.get("id")+" address:"+value.get("address"));
...
//				System.err.println("data:"+data);
				...
				Map<String, Object> map = XmlUtil.Dom2Map(result);
