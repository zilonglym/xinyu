...
import com.xinyu.util.web.HttpUtil;
...
public class XmlUtil {
	 ...
	 * @return
	 */
	public static String converterPayPalm(Map<String, Object> dataMap, String enums) {
		synchronized (XmlUtil.class) {
			StringBuilder strBuilder = new StringBuilder();
			// strBuilder.append("<?xml version='1.0' encoding='UTF-8' ?>\n");
			strBuilder.append("<").append(enums).append(">");
	...
	public static void main(String[] args) throws DocumentException {
		...
		xmlPar.put("mailNo", "885991302975917486");
		xmlPar.put("cpCode", "YTO");
		xmlPar.put("appName", "中仓网络仓储");
		String method = "LPC_PACK_PUB_QUERY";
		String xmlStr = XmlUtil.converterPayPalm(xmlPar, "request");

		String resultStr = HttpUtil.submitLogist(xmlStr, method);
	...
	public static void addressTest() {
		Map<String, Object> xmlPar = new HashMap<String, Object>();
		String method = "TMS_DISPATCH_FIND_SEND_BRANCH";
		Map<String,Object> params=new HashMap<String, Object>();
		params.put("addressReq", "广东省 深圳市 龙岗区 坂田街道和磡村北一巷5号");
		xmlPar.put("addressReqList", params);
