...
<body>
	<table cellpadding="5">
	    		...
	    		<tr>
	    			<td>备注:</td>	
	    			<td><input class="easyui-textbox" type="text" name="remark" id="remark" data-options="multiline:true" style="width:180px;height:100px;" value="${roles.remark}"></input></td>
	    	  </tr>	
	    	 <tr>
				<td>权限设置:</td>
					<td>
	    				<#list menus as menu>
	    					<#if menu.check??>
	    						<input type="checkbox" checked="checked" id="menu" name="menu" value="${menu.id}"/>${menu.title}				
	    					<#else>		
