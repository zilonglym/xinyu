...
<body>
	<div style="margin-top: 5px;margin-bottom: 5px;">
		...
		<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-search'" onclick="javascript:inventory.search();" >查询</a>
	</div>
	
	<table id="tb_inventory"  >
		<thead>
			<tr>
	...
	<script type="text/javascript" src="${base}/scripts/system/admin/inventory.js"></script>
</body>
</html>
