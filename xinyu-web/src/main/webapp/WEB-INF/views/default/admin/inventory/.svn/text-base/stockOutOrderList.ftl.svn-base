...
<body>
	<div style="margin-top: 5px;margin-bottom: 5px;">
		...
		<select id="orderTypes" name="orderTypes" class="easyui-combobox" style="width:190px;">
			<option value=''>全部</option> 
			<#list types as type >
		...
		<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-search'" onclick="stockOutOrder.search();" >查询</a>
	</div>
	
	<table id="tb_stockOutOrder"  >
		<thead>
			<tr>
