...
<body>
	<div style="margin-top: 5px;margin-bottom: 5px;">
		...
		<select id="status" name="status" class="easyui-combobox" style="width:190px;">
			<option value=''>全部</option> 
			<#list status as sta >
				<option value='${sta.key}'>${sta.description}</option>
			</#list>
		</select>
		...
		<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add'" onclick="inventoryCount.add();" >新建</a>
		<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-search'" onclick="inventoryCount.search();" >查询</a>
	</div>
	
	<table id="tb_inventoryCount"  >
		<thead>
			<tr>
