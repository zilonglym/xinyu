...
<script  language="javascript" type="text/javascript">
    ...
    function OpenPreview() {
		...
		<#list 1..count as i>
   	    ...
   	    LODOP.ADD_PRINT_TEXT(5,5,370,18,"${user.subscriberName}");
   	    LODOP.SET_PRINT_STYLE("FontSize",25);
   	    LODOP.ADD_PRINT_TEXT(30,5,390,100,"${item.name}:${item.itemCode}:${item.specification}");
   	    //下方运单号 条形码
   	    LODOP.SET_PRINT_STYLE("FontSize",10);
   	    LODOP.ADD_PRINT_BARCODE(125,50,300,85,"EAN13","${item.barCode}");
   	 	</#list>
