...
<body>
	<div style="margin-top: 5px;margin-bottom: 5px;">
		...
		<input  style="width:300px;" id="searchText" name="searchText" type="text" class="easyui-textbox" data-options="prompt:'运单号/联系人电话/批次号/收件人/买家ID'"/>
	   	<a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'icon-search'" onclick="oldOrder.searchList();" >查询</a>
	...
	<script type="text/javascript" src="${base}/scripts/system/admin/oldOrder.js"></script>
</body>
</html>
