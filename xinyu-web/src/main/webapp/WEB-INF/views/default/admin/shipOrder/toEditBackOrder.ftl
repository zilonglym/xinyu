	...
	<div id="order">
		<table cellpadding="5">
	    		...
	    		<tr>	
	    			...
	    			<td>备注:</td>			
	    			<td><input class="easyui-textbox" type="text" id="description" name="description" style="width:200px;" value="${orderBack.description}"/></td> 
	    		</tr>
	    		 <input type="hidden" id="id" name="id" value="${orderBack.id}"/>
	   	 	</table>
		</div>
		<div id="items">
