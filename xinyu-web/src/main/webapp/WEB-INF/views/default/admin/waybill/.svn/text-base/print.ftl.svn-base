...
<script src="${base}/scripts/waybill/LodopFuncs.js" type="text/javascript"></script>
...
<script  language="javascript" type="text/javascript">
    ...
    function OpenPreview() {
        ...
        LODOP.SET_PRINT_PAGESIZE(1,"2300","1270","LodopCustomPage"); //设置打印纸张,根据具体要求定尺寸
		LODOP.SET_PRINT_MODE("POS_BASEON_PAPER",true);
	
		//LODOP.ADD_PRINT_SETUP_BKIMG("<img border='0' src='${ctx}/themes/default/images/ems.png'/>");
		<#list results as obj>
   	   
   	    LODOP.NewPage();
   	    //寄件人信息
   	    LODOP.SET_PRINT_STYLE("FontSize",10);
   	    LODOP.ADD_PRINT_TEXT(80,25,150,12,"${obj.senderName}");
   	    LODOP.ADD_PRINT_TEXT(80,200,120,12,"${obj.senderPhone}");
   	    LODOP.ADD_PRINT_TEXT(110,20,380,25,"${obj.senderAddress}");
   	   
   	   	//收件人信息
   	   	LODOP.SET_PRINT_STYLE("FontSize",11);
   	    LODOP.ADD_PRINT_TEXT(190,25,170,15,"${obj.receiverName}");
   	    LODOP.ADD_PRINT_TEXT(210,25,170,15,"${obj.receiverNick}");
   	    LODOP.ADD_PRINT_TEXT(210,200,170,15,"${obj.receiverPhone}");
   	    LODOP.ADD_PRINT_TEXT(190,200,170,15,"${obj.receiverMobile}");
   	    LODOP.ADD_PRINT_TEXT(240,20,380,70,"${obj.receiverAddress}");
   	   
   	   	//商品明细
   	   	LODOP.SET_PRINT_STYLE("FontSize",11);
   	    LODOP.ADD_PRINT_TEXT(130,20,380,30,"${obj.items}");
   	    
   	    //打印时间
   	    LODOP.SET_PRINT_STYLE("FontSize",10);
   	    LODOP.ADD_PRINT_TEXT(230,550,300,15,"${obj.printDate}");
