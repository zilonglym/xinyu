...
<button type="button" onclick="MyPrint();" class="btn btn-primary" id="btnPrint" >点击打印</button>
...
<div class="body" id="printLogDiv">
    <table border="0" width="100%"  height="100%">
        ...
        <tr>
            <td width="100%" colspan="16">
                <textarea  cols=150 rows=25 id="printLogoOutput" style="display:none;">
                </textarea>
            </td>
        </tr>
    </table>
...
//	var LODOP; //声明为全局变量
	...
	function MyPrint() {	
		...
		var json=idStr.split(",");
		var s=json.length;
		var obj,html,ids="",page=0;
		$.ajax({
		 type:'post',
		  url: ctx+"/express/getSfPrint",
		  data: {ids:idStr,cpCode:'SF',batchCode:batchCode,type:type}, 
		  cache: false,
		  async:true,
		...
		//标记E
		 ...
		 //上方运单号 条形码
   	   ...
   	   // LODOP.SET_PRINT_STYLE("FontSize",8); 
   	    ...
   	    LODOP.ADD_PRINT_TEXTA("s_weight",206,209,53,18,obj.weight);
   	    LODOP.SET_PRINT_STYLE("FontSize",8);
   	    //打印时间
