...
var delivery={};
		...
		delivery.searchList=function(){
			var user=$("#selectUser").combobox('getValue');
			var selectCompany = $("#selectCompany").combobox('getValue');
	   		...
	   		var txtno = $("#txtno").textbox('getValue');
			location.href = ctx + "/shipOrder/deliveryorderList?userId="+user+"&selectCompany="+selectCompany+"&status="+status+"&q="+q+"&beigainTime="+beigainTime+"&lastTime="+lastTime+"&txtno="+txtno+"&searchType="+searchType;
